...
exports.SuppliersModule = SuppliersModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([supplier_entity_js_1.Supplier])],
        controllers: [suppliers_controller_js_1.SuppliersController],
        providers: [suppliers_service_js_1.SuppliersService],
        exports: [suppliers_service_js_1.SuppliersService],
    })
], SuppliersModule);
