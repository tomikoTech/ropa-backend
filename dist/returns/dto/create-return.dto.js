...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID del item de la venta original' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'ID de la venta original' }),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], CreateReturnDto.prototype, "saleId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Producto defectuoso' }),
