...
exports.PromotionsModule = PromotionsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([promotion_entity_js_1.Promotion])],
        controllers: [promotions_controller_js_1.PromotionsController],
        providers: [promotions_service_js_1.PromotionsService],
        exports: [promotions_service_js_1.PromotionsService],
    })
], PromotionsModule);
